...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        # only apply in self-attention module and mlp weight matrics
        TARGET_MODULES = [
            "q_proj",
            "k_proj",
            "v_proj",
        ...
        # scale weight by alpha/r, a is rounghly the same as lr
        ...
        peft_config.save_pretrained("models/llama-13b-hf-lora")
