...
def main():
    ...
    if model_args.tokenizer_name:
        ...
        tokenizer = LlamaTokenizer.from_pretrained(model_args.model_name_or_path, add_bos_token=True, add_eos_token=True, **tokenizer_kwargs)
    else:
        raise ValueError(
    ...
    if training_args.do_train:
        raw_dataset = load_dataset("json", data_files=data_args.train_file)
        ...
        #                             tokenizer=tokenizer)
        logger.info(f"length of the training set: {len(train_dataset)}.")
